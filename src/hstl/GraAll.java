...
public class GraAll extends Application{
...
public void btn (ActionEvent event) throws Exception,IOException{
		...
		series.getData().add(new XYChart.Data<String , Number>("J0", 99.999));
		series.getData().add(new XYChart.Data<String , Number>("J1", 99.999));
		series.getData().add(new XYChart.Data<String , Number>("J2", 99.989));
		series.getData().add(new XYChart.Data<String , Number>("J3", 99.974));
		series.getData().add(new XYChart.Data<String , Number>("J4", 99.950));
